...
public class EmployeeAddedDelegate implements TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		...
		delegateTask.setVariable("currentState", EmployeeState.INCHECK.toString());
		delegateTask.setVariable("nextEvent", TaskEvent.APPROVED.toString());
		employeeService.addEmployeeEvent(businessKey, EmployeeState.INCHECK);
	}

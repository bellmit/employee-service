...
public class EmployeeApprovedDelegate implements TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		...
		delegateTask.setVariable("currentState", EmployeeState.ACTIVE.toString());
		delegateTask.removeVariable("nextEvent");
		employeeService.addEmployeeEvent(businessKey, EmployeeState.ACTIVE);
	}
